...
public class Config implements IMixinConfigPlugin {
    ...
    private static final File configFile = new File(FabricLoader.getInstance().getConfigDir().toFile(), "fast_recipe_search.toml");
    private static final File legacyFile = new File(FabricLoader.getInstance().getConfigDir().toFile(), "fast_recipe_search.properties");
